document.getElementById('port-scan-form').addEventListener('submit', function(event) {
    ...
    const targetIp = document.getElementById('ip-address').value;

    fetch('https://port-scan-1.onrender.com/scan', {  //http://127.0.0.1:5000/PortScanAPI.py'  https://port-scan-1.onrender.com/scan
        method: 'POST',
        headers: {
